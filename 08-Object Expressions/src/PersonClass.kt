...
class PersonClass (val firstname:String = "Luke", val lastname:String = "Skywalker, and this information comes from PersonClass.kt") {
    var nickname:String? = null
        ...
        get() {
            println("The returned value is $field") /*In this case, it outputs:  The returned value is null*/
            return field
