...
//    provider.sessionIDPrefix /*This will ONLY be available as a suggestion in the public API in the IDE --IF-- open val sessionIDPrefix is set in PersonInfoProvider.kt file. If it's protected open val sessionIDPrefix, then it will not work, or autosuggest in public API, but still be available for fancyinfoprovider-inheritance.kt. GOOD SECURITY!*/
    ...
    //val entity:Entity = Entity.Companion.create()  /* This is for the 09-Companion Object section, and also implements EntityFactory-Companion.kt file*/
    val entity = Entity.Factory.create() /*Cleaner way to do above code, especially if you have to do java/kotlin interoperability*/
    ...
    println (Entity.Factory.getId()) /*Print line added to just show that the override of fun getId()in EntityFactory-CompanionObjects.kt works. He didn't do this in the video.*/
